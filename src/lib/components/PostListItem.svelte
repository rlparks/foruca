...
<li>
	<a href={`/boards/${post.boardName}/${post.id}`}>
		<div
			class="flex h-14 flex-col justify-center px-4 transition duration-150 ease-in-out hover:bg-gray-50"
		>
	...
	<a href="heck">
		<div
			class="flex h-10 flex-col justify-center px-4 transition duration-150 ease-in-out hover:bg-gray-50"
		>
			<div class="flex align-middle text-sm text-gray-600">
				<span>
